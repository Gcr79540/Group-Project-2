...
Given the results from the data set, from 2015 to 2022 we find a higher average across states that are from the east compared to the west (given montana as an outlier) from how much darker it is. It also shows that males are more affected than females.  
